...
const dress1 = require('../Streetmall/kidswear/kidswear2.webp');
const dress2 = require('../Streetmall/kidswear/kidswear1.jpeg');
const dress3 = require('../Streetmall/kidswear/kidswear3.jpg');
const dress4 = require('../Streetmall/kidswear/kidswear4.webp');
const dress5 = require('../Streetmall/kidswear/kidswear5.webp');
const dress6 = require('../Streetmall/kidswear/kidswear6.jpg');

library.add(faMagnifyingGlass, faUsersViewfinder);

const Kidswear = ({ navigation }) => {
