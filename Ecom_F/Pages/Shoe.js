...
const dress1 = require('../Streetmall/shoes/shoe1.webp');
const dress2 = require('../Streetmall/shoes/shoe2.jpg');
const dress3 = require('../Streetmall/shoes/shoe3.webp');
const dress4 = require('../Streetmall/shoes/shoe4.jpg');
// const dress5 = require('../Streetmall/shoes/shoe5.jpeg');
    ...
    return (
        <View style={styles.containerw}>
            <ScrollView style={styles.all} vertical showsVerticalScrollIndicator={false}>
                ...
                <Text style={styles.categoryLabel1}>Shoe</Text>
                <View>
